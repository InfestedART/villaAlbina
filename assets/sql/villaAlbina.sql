...
(24, 'Direccion', '', NULL, '<p>Villa Albina está ubicada en Pairumani, Municipio de Vinto, a 23 kilómetros desde el centro de la ciudad de Cochabamba.</p>\n<p>Para llegar en transporte público, se recomienda tomar el Minibus 211 (bandera roja) de la Plaza Bolivar en la provincia de Quillacollo.</p>', 1);
...
(207, 'uploads/noticias/clg_2806.jpg', 'ACOGEDOR La sala de lectura de la familia Patiño. | DANIEL JAMES', 1, 2133),
(205, 'uploads/noticias/clg_7483.jpg', 'La mansión de la Hacienda Pairumani, los interiores deslumbran. | DANIEL JAMES', 1, 2051),
(206, 'uploads/noticias/clg_7545.jpg', 'Los interiores deslumbran. | DANIEL JAMES', 2, 2051),
(208, 'uploads/noticias/clg_2815.jpg', 'ATRACTIVO | DANIEL JAMES', 2, 2133),
(209, 'uploads/noticias/clg_2784.jpg', 'Atractivo El dormitorio principal de los esposos Patiño tiene un lavamanos y muebles para la recreación. | DANIEL JAMES', 3, 2133);
...
(2051, ' Villa Albina, el escenario de la vida de los Patiño Rodríguez', 'uploads/noticias/clg_6800.jpg', ' La mansión de la Hacienda Pairumani se erige imponente y sobrio en medio de la maravillosa campiña. | DANIEL JAMES', 1, 1),
(213, 'El rostro escondido de Villa Albina abre sus puertas hoy', 'uploads/noticias/2019N289975.jpg', '', 1, 1),
(2046, 'Don Simón y Doña Albina. Horizontes Compartidos', 'uploads/libros/DVD-VIDEO-EXPOSICION.jpg', NULL, 1, 2),
(2131, 'Historias de Oruro', 'uploads/libros/DSCN0114.JPG', NULL, 1, 2),
(2133, ' Villa Albina, abren el tesoro mejor guardado', 'uploads/noticias/clg_3235.jpg', 'IMPONENTE Villa Albina capta la atención de los visitantes desde que ingresan al lugar. Es una imponente edificación en medio de una exuberante naturaleza. | DANIEL JAMES', 1, 1),
(350, 'Fotografías para la historia. Simon I. Patiño: Estaño y Vida Cotidiana, 1900 - 1930', 'uploads/libros/libro2.jpg', NULL, 1, 2),
(2052, ' De nuevo la magia', '', '', 1, 1),
(2134, ' Villa Albina, el día a día de los Patiño ', 'uploads/noticias/ubicada-medio-propiedad-rodeada-olivos_LRZIMA20190604_0015_7.jpg', '  Una vista de la casa que está ubicada en el medio de la propiedad, rodeada de olivos.', 1, 1);
...
--
ALTER TABLE `contenido`
  MODIFY `id_content` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `galeria`
  MODIFY `id_img` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
--
