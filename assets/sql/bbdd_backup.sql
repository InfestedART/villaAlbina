...
--
-- Servidor: localhost
-- Tiempo de generación: 31-03-2019 a las 14:39:49
...
--
-- Estructura de tabla para la tabla `c_default`
--
...
INSERT INTO `pagina` (`id_pagina`, `titulo`, `enlace`, `seccion`, `color`, `status`, `external`, `id_modelo`, `id_contenido`) VALUES
...
INSERT INTO `subarea` (`id_subarea`, `nombre_subarea`, `enlace`, `componente`, `imagen`, `status`, `id_pagina`, `id_contenido`) VALUES
(1, 'Nuestra Historia', 'historia', 'default', 'subareas/historia.jpg', 1, 1, NULL),
(2, 'Nuestra Misión y Visión', 'mision_vision', 'default', 'subareas/equipo.jpg', 1, 1, NULL),
(3, 'Nuestro Equipo de Trabajo', 'equipo_trabajo', 'equipo', 'subareas/mision_vision.jpg', 1, 1, NULL);
...
--
-- Indices de la tabla `c_default`
--
ALTER TABLE `c_default`
  ADD PRIMARY KEY (`id_post`);
...
--
-- AUTO_INCREMENT de la tabla `c_default`
--
ALTER TABLE `c_default`
